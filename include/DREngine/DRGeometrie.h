...
class DRENGINE_EXPORT DRGeometrie : public DRIResource
{
public:
    DRGeometrie();
    virtual ~DRGeometrie();
    ...
    inline DRVector3* getVertexPointer() {return mVertices;}
    inline DRColor*   getColorPointer()  {return mColors;}
    inline GLuint*    getIndexPointer()  {return mIndices;}
    inline DRVector2* getTextureCoordsPointer(u32 index) {if(index >= mNumTextureCoords) return NULL;
                                                              if(!mTextureCoords) return NULL;
                                                              return mTextureCoords[index];}

    inline u32    getVertexCount() {return mVertexCount;}
...
typedef std::shared_ptr<DRGeometrie> DRGeometriePtr;
