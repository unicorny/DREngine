...
class DRENGINE_EXPORT DRHeightValueStorage
{
public:
...
class DRENGINE_EXPORT DRGeometrieIcoSphere : public DRGeometrieSphere
{
public:
    ...
    inline void setHeightValueStorage(DRHeightValueStorage* heightValueStorage) {mHeightValues = heightValueStorage;}
...
private:
    ...
    DRReturn calculateNormals(u32 oldVertexCount);
