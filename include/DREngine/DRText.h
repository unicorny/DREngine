...
public:
	...
	inline	float getTextHeight() {return m_FInfo.fHeight;};
...
public:
	...
	inline DRFont* getFont() {return m_pFont;};

	//! \brief liefert die aktuellen Flags
	//! \return die flags als unsigned int
	inline unsigned int getFlags() {return uiFlags;};
